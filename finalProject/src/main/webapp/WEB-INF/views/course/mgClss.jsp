...
<div style="width: 45%; float: left">
 	<form action="clssInsert.do" id="frmClss">
		<fieldset style="width: 100%">
			...
			<table>
				...
				<tr>
					...
					<td><input class="w3-button w3-round-large w3-teal"  type="button" value="해당 과정 강좌 리스트 " onclick="clssSelectByCourse('${root}', document.getElementById('crsId').value)">
					</td>
		...
		<input class="w3-button w3-round-large w3-teal"  type="reset" value="화면 초기화"> 
 		<input class="w3-button w3-round-large w3-teal"  type="submit" value="강좌 개설"> 
		<input class="w3-button w3-round-large w3-teal"  type="button" value="수정 내용 저장" onclick="clssUpdate()">
		<input class="w3-button w3-round-large w3-teal"  type="button" value="강사 배정" onclick="tchrShow()">
		<input class="w3-button w3-round-large w3-teal"  type="button" onclick="javascript:history.back()" value="이전 화면으로"><br>
		<br>
		<div>
		<fieldset style="width: 80%" id="fsTchr" hidden>				
			...
			<table style="float:left; height:250px">
				...
				<tr>
					<td colspan="3">
						<input class="w3-button w3-round-large w3-teal"  type="button" value="화면초기화" id="btnClear">
						<input class="w3-button w3-round-large w3-teal"  type="button" value="저장" onclick="assgnTchr('${pageContext.request.contextPath}')">
						<input class="w3-button w3-round-large w3-teal"  type="button" value="닫기" onclick="tchrClose()">
					</td>
				</tr>
			</table>
