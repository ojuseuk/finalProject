			...
			$('#dataTable').DataTable({
				...
				columns : [ {
						...
						"render" : function(data, type, row, meta){
							...
							data  = '<div align="center"><input class="w3-button w3-round-large w3-blue-grey w3-tiny" style="background-color: #90909096" type="button" value="' + data + '" onclick="clssSelect(\''+ root + '\', \''+data+'\')"></div>'
							return data;
						}
					}, {
						"data" : "sbjtNm"
					...
					/* 강사 리스트 DataTable 채우기*/
		 			$('#dtTchr').DataTable({
		 				...
		 				columns : [ {
	 						...
	 						"searchable": false,
							"render" : function(data, type, row, meta){
								data  = '<div align="center"><input class="w3-button w3-round-large w3-blue-grey w3-tiny" style="background-color: #90909096" type="button" value="' + data + '" onclick="tchrSelect(\''+ root + '\', \''+data+'\')"></div>'
								return data;
							}
	 					}, {
	 						"data" : "nm"
